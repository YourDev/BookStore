module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/lib/lodash/lodash.min.js',
            'src/main/webapp/lib/angular-simple-logger/angular-simple-logger.min.js',
            'src/main/webapp/lib/angular-google-maps/angular-google-maps.min.js',
